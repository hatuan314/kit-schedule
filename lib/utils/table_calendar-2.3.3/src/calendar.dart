//  Copyright (c) 2019 7-8o4Aleksander Woźniak
...
class TableCalendar extends StatefulWidget {
  ...
  TableCalendar({
    ...
    this.builders = const CalendarBuilders(), this.drawerWidget, this.searchWidget,
...
class _TableCalendarState extends State<TableCalendar>
  ...
  Widget _buildHeader() {
    final children = [
      widget.headerStyle.drawerWidgetVisible ? widget.drawerWidget : Container(),
      ...
      widget.headerStyle.rightChevronVisible
          ...
          : Container(),
      widget.headerStyle.searchWidgetVisible ? widget.searchWidget : Container(),
