...
class HeaderStyle {
  ...
  /// Determines left drawer visibility.
  /// Defaults to `false`.
  final drawerWidgetVisible;
  /// Determines right search visibility.
  /// Defaults to `false`.
  final searchWidgetVisible;


  const HeaderStyle({
    this.drawerWidgetVisible=false,
    this.searchWidgetVisible=false,
